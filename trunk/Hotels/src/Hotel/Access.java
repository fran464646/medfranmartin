...
public ArrayList<Hotel> getHotelsByCity(Connection conexion, String city) throws SQLException
{
ArrayList<Hotel> hotelList = new ArrayList<Hotel>();
PreparedStatement stmt = conexion.prepareStatement("SELECT * FROM hotel where ciudad LIKE '%"+ city +"%'");
ResultSet rs = stmt.executeQuery();
try
{
while(rs.next())
